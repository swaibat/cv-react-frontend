...
class Filter extends Component {
	render() {
		return (
			<ul class='navbar-nav mr-auto sidenav pl-0' id='navAccordion'>
				<li class='nav-item rounded'>
					<a class='nav-link nav-link-collapse bg-primary text-white d-flex justify-content-between px-2' href='#' id='hasSubItems' data-toggle='collapse' data-target='#collapseSubItems4' aria-controls='collapseSubItems4' aria-expanded='false'>
						Car Make
						<span>
							<Icon icon={Arrow} />
						</span>
				...
				<li class='nav-item'>
					<a class='nav-link nav-link-collapse border-bottom text-secondary text-white d-flex justify-content-between px-2' href='#' id='hasSubItems' data-toggle='collapse' data-target='#collapseSubItems4' aria-controls='collapseSubItems4' aria-expanded='false'>
						Body type
						<span>
							<Icon icon={Arrow} />
						</span>
