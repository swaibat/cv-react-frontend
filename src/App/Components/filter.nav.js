			...
			<div className='d-flex flex-column'>
				<ul className='navbar-nav mr-auto sidenav p-2 sidenav-filter bg-white shadow-xs rounded h-auto mb-2' id='navAccordion'>
					<li className='nav-item mb-3 text-secondary'>
						<a className='nav-link nav-link-collapse border-bottom text-secondary text-white d-flex justify-content-between px-2 rounded' href='#' id='hasSubItems' data-toggle='collapse' data-target='#collapseSubItems3' aria-controls='collapseSubItems3' aria-expanded='true'>
							My WishList
							<span>
