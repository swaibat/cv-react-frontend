			...
			<>
				...
				<main className='d-flex flex-column align-items-center'>
					<div className='container p-1 p-md-2 min-vh-80 d-flex w-100 row justify-content-center align-items-center '>
						<div className='d-flex icons-lg text-secondary align-items-center justify-content-between mt-n6 bg-white w-100 rounded p-3 z-ndex-1 font-weight-light shadow-xs'>
							<div className='card cat-card d-flex align-items-center justify-content-around p-2'>
						...
						<div className='h-50 w-100 py-3'>
							<div className='m-0 p-2 bg-white shadow-xs mt-3 row rounded'>
								<h5 className='cv-title col-12'>Top deals</h5>
								<div className='col-md-2 col-sm-4 p-1 p-md-2'>
									<a href='/products/techno spark 4' className='card text-secondary w-100 bg-white'>
										<div className='banner_holder rounded'>
											<div className='banner_holderImage img-thumbnail'></div>
										</div>
										<div className='card-footer px-0 py-1 bg-transparent d-flex justify-content-between align-items-center'>
											<h6 className='mb-0'>450000</h6>
											<small className='badge text-primary bg-primary-light rounded-0'>
												45% off
											</small>
										</div>
									</a>
								...
								<div className='col-md-2 col-sm-4 p-1 p-md-2'>
									<a href='/products/techno spark 4' className='card text-secondary w-100 bg-white'>
										...
										<div className='card-footer px-0 bg-transparent d-flex justify-content-between align-items-center'>
											<h6 className='mb-0'>450000</h6>
											<small className='badge text-primary bg-primary-light rounded-0'>
												45% off
											</small>
						...
						<div className='h-50 w-100 py-2'>
							<div className='row'>
								<div className='col-6'>
									<div className='row m-2 bg-white shadow-xs rounded'>
										<h5 className='cv-title col-12'>Top rated</h5>
										<div className='col-md-3 col-sm-4 p-1 p-md-2'>
											<a
												href='/products/techno spark 4'
												className='card text-secondary w-100 bg-white'
											>
												<div className='banner_holder rounded'>
													<div className='banner_holderImage img-thumbnail'></div>
												</div>
										...
										<div className='col-md-3 p-1 p-md-2'>
											<a
												href='/products/techno spark 4'
												className='card text-secondary w-100 bg-white'
											>
								...
								<div className='col-6'>
									<div className='row m-2 bg-white shadow-xs rounded'>
										<h5 className='cv-title col-12'>Similar adverts</h5>
										<div className='col-md-3 col-sm-4 p-1 p-md-2'>
											<a
												href='/products/techno spark 4'
												className='card text-secondary w-100 bg-white'
						...
						<div className='h-50 w-100 py-3'>
							<div className='m-0 p-2 bg-white shadow-xs mt-3 row rounded'>
								<h5 className='cv-title col-12'>Popular Sellers</h5>
								<div className='col-md-2 col-sm-4 p-1 p-md-2'>
									<a href='/products/techno spark 4' className='card text-secondary w-100 bg-white'>
										<div className='banner_holder rounded'>
											<div className='banner_holderImage img-thumbnail'></div>
						...
						<div className='h-50 w-100 py-2'>
							<div className='row'>
								<div className='col-md-3 p-1 p-md-2'>
									<a
										href='/products/techno spark 4'
										className='card border-0 shadow-xs text-secondary w-100 bg-white'
									>
										<div className='banner_holder rounded'>
											<div className='banner_holderImage img-thumbnail'></div>
										</div>
										<div className='card-footer px-0 py-1 bg-transparent d-flex justify-content-between align-items-center'>
											<h6 className='mb-0 pl-2'>USD 450</h6>
										</div>
									</a>
								</div>
								<div className='col-9'>
									<div className='row'>
										<div className='col-4'>
											<div className='d-flex flex-wrap my-2 bg-white shadow-xs rounded'>
												<p className='col-12 font-weight-bold mb-0'>Sports Activities</p>
												<div className='col-md-4 p-1 p-md-2'>
													<a
														href='/products/techno spark 4'
														className='card item-card-xs text-secondary w-100 bg-white'
													>
														<div className='banner_holder rounded'>
															<div className='banner_holderImage img-thumbnail'></div>
														</div>
