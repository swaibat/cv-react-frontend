...
import RegisterSuccess from './register.success.page';
															...
															>
																...
																>
																	...
																	<div className='input-group form-group mb-3'>
																		<div className='input-group-prepend rounded-0'>
																			<span className='input-group-text cv-input-group-text rounded-0 p-1 border-bottom '>
																	...
																	<div className='input-group form-group mb-3'>
																		<span className='input-group-text bg-transparent cv-input-group-text rounded-0 p-0 border-bottom '>
...
const mapDispatchToProps = dispatch => {
	return {
		...
		register: async (email, token) => dispatch(await Auth.register(email, token)),
