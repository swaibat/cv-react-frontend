...
import Variables from './adons/cars.adon';
...
const CreateProduct = () => {
	...
	useSelector(({ createItem }) => createItem.payload && setStatus(createItem.payload.status));
	return (
		<div className='card mt-4'>
			{status === 201 && <Redirect to='/admin/products' />}
