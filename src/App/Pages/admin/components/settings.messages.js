			...
			<div className='tab-pane bg-white text-secondary rounded py-3 px-4 fade shadow-xs show active' id='v-pills-settings' role='tabpanel' aria-labelledby='v-pills-settings-tab'>
				...
				<form className='h-100'>
					<li className='d-flex justify-content-between py-3 border-bottom'>
						...
						<select name='verificationType' className='form-control custom-control custom-input px-0  w-25'>
					...
					<li className='d-flex justify-content-between py-3 border-bottom'>
						...
						<select name='notificationType' className='form-control custom-control custom-input px-0  w-25'>
							<option value='both'>Both phone and email</option>
							<option value='email'>Email</option>
							<option value='phone'>Phone </option>
						</select>
					...
					<div className='form-group form-row'>
						...
						<div className='col-md-5'>
							<input name='twilo_accountSid' className='form-control custom-control custom-input px-0' placeholder='enter your accountSid' />
						</div>
					</div>
					<div className='form-group form-row'>
						<label htmlFor='inputPassword' className='col-md-7 col-form-label'>
						...
						<div className='col-md-5'>
							<input name='twilo_authToken' className='form-control custom-control custom-input px-0' placeholder='enter your authToken' />
						</div>
					</div>
					<div className='form-group form-row'>
						<label htmlFor='inputPassword' className='col-md-7 col-form-label'>
						...
						<div className='col-md-5'>
							<input name='twilo_serviceId' className='form-control custom-control custom-input px-0' placeholder='enter your serviceId' />
						</div>
					</div>
