...
import { GetFaq, createFaq, deleteFaq, updateFaq } from '../../../redux/actions/faq.action';
...
const mapDispatchToProps = dispatch => {
	return {
		...
		createFaq: async (data, token) => dispatch(await createFaq(data, token)),
		delete: async (id, token) => dispatch(await deleteFaq(id, token)),
		update: async (id, data, token) => dispatch(await updateFaq(id, data, token)),
	};
};
